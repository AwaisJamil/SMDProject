...
public class CONTACTS extends Fragment implements ContactAdapter.ViewHolder.ClickListener{
  ...
  //  private CHATS.OnFragmentInteractionListener mListener;
    ...
    public List<Contact> setData(){
        ...
        String number[]={"03001234567","03211254367","03134303030","03001111444","03007654321","03111238742","03228866555","03001234567","03405544333","03484848148"};
    ...
    public void onItemClicked (int position) {
        Intent intent = new Intent("com.example.awais.test.contactDetail");
